...
begin
    WaitForResources:
        while TRUE do
            await reserved + resources_left >= resources_needed;
...
\* BEGIN TRANSLATION (chksum(pcal) = "2ae269dd" /\ chksum(tla) = "fac9cb4c")
...
WaitForResources(self) == /\ pc[self] = "WaitForResources"
                          /\ reserved + resources_left >= resources_needed[self]
...
\* Last modified Mon Dec 16 13:49:50 CET 2024 by duke-deuce
